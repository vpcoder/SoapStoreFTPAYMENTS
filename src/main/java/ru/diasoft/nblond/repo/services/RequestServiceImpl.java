...
import ru.diasoft.nblond.repo.serialization.convert.RequestConverterImpl;
...
public class RequestServiceImpl implements RequestService {
    ...
    public List<RequestDataModel> getRequests(User user, String method) {
        var list = requestRepository.findRequests(user, method);
        return list.stream()
    ...
    public RequestDataModel addRequest(User user, String method, String name, String body) {
        var request = converter.create(user, name, method, body);
